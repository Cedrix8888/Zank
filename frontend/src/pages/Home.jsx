        ...
        <div>
            <div className="text-center py-36">
                ...
                <div className="text-center mt-10">
                    <Link to="/workspace/background" className="rounded-md bg-gray-100 px-2.5 py-2 text-sm font-semibold text-black shadow-sm hover:bg-black hover:text-white">Get started</Link>
                </div>
            </div>
        </div>
    );
